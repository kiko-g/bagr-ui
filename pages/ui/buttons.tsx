  ...
  return (
    <ComponentTypePage
      ...
      components={[
        ...
        { name: "Simple w/ Border", path: "buttons/ButtonSimpleBorder.tsx", component: <ButtonSimpleBorder /> },
        { name: "Simple w/ Icon", path: "buttons/ButtonSimpleIcon.tsx", component: <ButtonSimpleIcon /> },
        { name: "Disabled", path: "buttons/ButtonDisabled.tsx", component: <ButtonDisabled /> },
        ...
        { name: "Translate Animation", path: "buttons/ButtonTranslate.tsx", component: <ButtonTranslate /> },
      ]}
    />
  )
}
