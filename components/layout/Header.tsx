...
export function Header() {
  return (
    <header className="max-w-8xl sticky top-0 z-30 mx-auto h-[72px] w-full bg-gray-50 bg-opacity-40 backdrop-blur-sm backdrop-filter dark:bg-gray-900 dark:bg-opacity-40 xl:px-8">
