  ...
  return (
    <div
      className={clsx(
        ...
        type === "info" &&
          "border-sky-600 bg-sky-600/10 text-gray-900 dark:border-sky-400 dark:bg-sky-400/30 dark:text-white",
        type === "error" &&
          "border-rose-600 bg-rose-600/10 text-gray-900 dark:border-rose-400 dark:bg-rose-400/30 dark:text-white",
        type === "warning" &&
          "border-amber-600 bg-amber-600/10 text-gray-900 dark:border-amber-400 dark:bg-amber-400/30 dark:text-white",
        type === "success" &&
          "border-emerald-600 bg-emerald-600/10 text-gray-900 dark:border-emerald-400 dark:bg-emerald-400/30 dark:text-white",
        type === undefined &&
          "border-slate-600 bg-slate-600/10 text-gray-900 dark:border-slate-400 dark:bg-slate-400/30 dark:text-white",
        noBorder && "border-0",
      )}
    >
      {noBubble ? null : (
