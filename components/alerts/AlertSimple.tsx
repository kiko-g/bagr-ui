...
export function AlertSimple({ headline, type = "info" }: Props) {
  return (
    <div
    ...
    >
      ...
      >
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec aliquet dui. Nulla facilisi. Nulla facilisi.
      </p>
    </div>
  )
}
