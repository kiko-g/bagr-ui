...
export function ButtonFill() {
  ...
  return (
    <button
      onClick={myFunction}
      className="group relative flex items-center justify-center gap-x-2 rounded-sm border-2 border-primary-700 px-8 py-3 text-primary-900 disabled:cursor-not-allowed disabled:opacity-25 dark:border-secondary-900 dark:text-white"
    >
