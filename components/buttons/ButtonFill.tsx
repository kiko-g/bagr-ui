...
export function ButtonFill() {
  ...
  return (
    <button
      onClick={myFunction}
      className="group relative flex items-center justify-center gap-x-2 rounded-sm border-2 border-pink-400 px-8 py-3 text-gray-700 disabled:cursor-not-allowed disabled:opacity-25 dark:text-white"
    >
